...
import com.lunchbag.lunchbag.java.adapter.RestaurantAdapter;
import com.lunchbag.lunchbag.java.model.Rating;
import com.lunchbag.lunchbag.java.model.Restaurant;
import com.lunchbag.lunchbag.java.util.RatingUtil;
...
public class MainActivity extends AppCompatActivity implements
    ...
    public void onFilter(Filters filters) {
        ...
        // Place (equality filter)
        if (filters.hasPlace()) {
            query = query.whereEqualTo(Restaurant.FIELD_PLACE, filters.getPlace());
        }
